...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
     ...
     [MAC_FN1] = LAYOUT_ansi_69(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUD, RGB_SAI, RGB_SPI,              KC_LEFT, KC_DOWN,   KC_UP,   KC_RGHT, _______,  _______,            _______,             KC_END,
    ...
    [_FN2] = LAYOUT_ansi_69(
        ...
        _______, _______,  KC_UP,    _______, _______, _______,              KC_HOME, KC_END,   _______, _______,  _______,  _______,  _______,  _______,             _______,
        _______, KC_LEFT,  KC_DOWN,  KC_RGHT, _______, _______,              KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT,  _______,  _______,            _______,             _______,
        _______,           _______,  _______, _______, _______, BAT_LVL,     KC_DEL,  KC_HOME,  _______, _______,  _______,  _______,  _______,            _______,
        _______, _______,            _______,          _______, _______,     _______,           _______,           _______,                      _______,  _______,   _______),
};
